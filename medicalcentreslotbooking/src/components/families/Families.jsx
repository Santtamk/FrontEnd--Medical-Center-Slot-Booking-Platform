...
const Families = () => {
  return (
    <div className="bg-white-off ">
        <div className="m-8 md:p-10 flex flex-col md:flex-row lg:mx28">
            <div className="lg:w-6/12 md:w-6/12 flex flex-col items-left justify-center gap-5">
                <div className="text-sky text-base font-semibold">
                CARING FOR THE HEALTH OF YOU AND YOUR FAMILY.
                </div>
                <div className="text-navy font-semibold text-5xl">
                Our Families
                </div>
            ...
            <div className="pt-4 flex items-center justify-center lg:w-6/12 md:w-6/12">
                <img src="./4images.png" alt="4images" />
            </div>
